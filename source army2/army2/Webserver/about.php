<?php 
  $title = "Giới Thiệu - MobiArmy II";
  include './include/head.php';
?>
<div class="bg-content content">
  <div class="content">
    <p><span style="font-size:27px">C&aacute;ch chơi:</span></p>
    <p>Bạn phải t&iacute;nh to&aacute;n g&oacute;c bắn v&agrave; lực bắn kết hợp với sức gi&oacute; để đường đi của vi&ecirc;n đạn tr&uacute;ng đ&iacute;ch, c&aacute;ch chơi như sau:</p>
    
    <p>Chờ đến lượt của m&igrave;nh để bắn.</p>
    
    <p>Đồng hồ sẽ hiển thị thời gian lượt bắn, nếu hết thời gian m&agrave; chưa bắn th&igrave; sẽ mất lượt. Ch&uacute; &yacute; l&agrave; bạn c&oacute; thể bị mất lượt do mạng bị lag.</p>
    
    <p>Dùng phím mũi tên trái phải đối với điện thoại không cảm ứng, hoặc chạm vào nút di chuyển đối với màn hình cảm ứng để di chuyển nhân vật. Chú ý vào thanh sức lực, nếu hết sức thì nhân vật không thể di chuyển được.</p>
    ...
    <p><strong>Khi chọn ph&ograve;ng chơi cần quan t&acirc;m c&aacute;c th&ocirc;ng số sau:</strong></p>
    
    <ul>
    	<li>Số tiền cược / v&aacute;n đấu.</li>
    	<li>Số người chơi / 1 ph&ograve;ng.</li>
    	<li>Bản đồ chiến đấu</li>
    </ul>
    
    <p><span style="font-size:27px">Chức năng ch&iacute;nh:</span></p>
    
    <p><strong>Đăng k&yacute;: </strong>Để đăng k&iacute;, h&atilde;y chọn mục Đăng k&iacute; trong game hoặc tại m&agrave;n h&igrave;nh đăng nhập.</p>
    
    <p><strong>Đăng nhập:</strong>Nếu đ&atilde; đăng k&iacute; ,h&atilde;y d&ugrave;ng t&ecirc;n t&agrave;i khoản v&agrave; mật khẩu để đăng nhập v&agrave;o tr&ograve; chơi.</p>
    
    <p><strong>Khu vực: </strong>Trong game sẽ tổ chức nhiều khu vực chơi, tương ứng với cấp độ người chơi, người chơi h&atilde;y lựa chọn cấp độ khu vực th&iacute;ch hợp để c&oacute; những đối thủ th&iacute;ch hợp. Danh s&aacute;ch c&oacute; th&ocirc;ng số cho biết số trận chiến đang trống v&agrave; đang chờ trong khu vực. Nếu biết được khu vực cần v&agrave;o th&ocirc;ng qua bạn b&egrave;, người chơi c&oacute; thể chọn t&igrave;m khu vực.</p>
    
    <p>Nếu v&agrave;o trận chiến đang trống, bạn sẽ l&agrave; chủ v&agrave; c&oacute; quyền đặt số tiền cược, đặt mật khẩu để v&agrave;o v&agrave; bắt đầu v&aacute;n chơi khi c&oacute; đủ người. Nếu kh&ocirc;ng phải l&agrave; chủ, bạn h&atilde;y chọn sẳn s&agrave;ng v&agrave; chờ chủ b&agrave;n bắt đầu v&aacute;n chơi.Nếu muốn l&agrave; chủ b&agrave;n, bạn h&atilde;y chọn mục Tạo khu vực.</p>
